 ...
 * @author DATNQ
 */
@XmlRootElement(name = "INTERN05_EXPORTORDERBO")
@JsonIgnoreProperties(ignoreUnknown = true)
public class Intern05ExportorderDTO extends BaseFWDTOImpl<Intern05ExportorderBO> {
	...
	@Override
	public Intern05ExportorderBO toModel() {
		Intern05ExportorderBO intern05ExportorderBO = new Intern05ExportorderBO();
		intern05ExportorderBO.setUnit(this.unit);
        intern05ExportorderBO.setQuantity(this.quantity);
        intern05ExportorderBO.setNote(this.note);
        intern05ExportorderBO.setPrId(this.prId);
        intern05ExportorderBO.setEmId(this.emId);
        intern05ExportorderBO.setCreateDate(this.createDate);
        intern05ExportorderBO.setExId(this.exId);
        intern05ExportorderBO.setUnitPrice(this.unitPrice);
		return intern05ExportorderBO;
	}
